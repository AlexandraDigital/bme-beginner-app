...
const MODULES = [
  { id:"physics-bme",title:"Physics for BME",emoji:"⚡",level:"Beginner",duration:"6 hours",color:"#fbbf24",grad:"linear-gradient(135deg,#92400e,#d97706)",
    lessons:[{id:"ph-1",title:"Mechanics: Motion, Forces & Energy",mins:50},{id:"ph-2",title:"Newton's Laws & Their BME Applications",mins:45},{id:"ph-3",title:"Fluid Mechanics & Blood Flow",mins:55},{id:"ph-4",title:"Electricity & Circuits for Biosignals",mins:60},{id:"ph-5",title:"Ohm's & Kirchhoff's Laws in Biomedical Systems",mins:50},{id:"ph-6",title:"Electromagnetic Waves: MRI & ECG",mins:45}],
    quiz:[{q:"Which law relates voltage, current, and resistance?",o:["Faraday's Law","Newton's Second Law","Ohm's Law","Bernoulli's Principle"],a:2},{q:"Fluid viscosity is most relevant to:",o:["Bone fracture","Blood flow in vessels","Nerve conduction","Cell division"],a:1},{q:"Work is defined as:",o:["Force × time","Mass × acceleration","Force × displacement","Voltage × current"],a:2},{q:"Which physical phenomenon underlies MRI imaging?",o:["Piezoelectric effect","Nuclear magnetic resonance","Photoelectric effect","Acoustic impedance"],a:1},{q:"Kirchhoff's Current Law states that:",o:["Voltage is constant in a loop","Sum of currents at a node equals zero","Resistance increases with temperature","Capacitors block AC current"],a:1}]},
  { id:"biology-chemistry",title:"Biology & Chemistry",emoji:"🧪",level:"Beginner",duration:"7 hours",color:"#34d399",grad:"linear-gradient(135deg,#065f46,#047857)",
    lessons:[{id:"bc-1",title:"Cell Biology: Structure & Organelles",mins:55},{id:"bc-2",title:"Anatomy: Body Systems Overview",mins:60},{id:"bc-3",title:"Physiology & Homeostasis",mins:55},{id:"bc-4",title:"General Chemistry & Chemical Reactions",mins:50},{id:"bc-5",title:"Organic Chemistry & Biomaterials",mins:60},{id:"bc-6",title:"Biochemistry: Proteins, Metabolism & Enzymes",mins:65}],
    quiz:[{q:"Homeostasis refers to:",o:["Cell division process","Body's ability to maintain stable internal conditions","Chemical bonding in polymers","DNA replication"],a:1},{q:"Which organelle is the powerhouse of the cell?",o:["Nucleus","Golgi apparatus","Mitochondria","Endoplasmic reticulum"],a:2},{q:"pH below 7 indicates:",o:["Alkaline solution","Neutral solution","Acidic solution","Saturated solution"],a:2},{q:"Proteins are made of:",o:["Nucleotides","Fatty acids","Amino acids","Monosaccharides"],a:2},{q:"Enzymes function by:",o:["Increasing activation energy","Providing energy to reactions","Lowering activation energy","Changing reaction products"],a:2}]},
  { id:"maths-bme",title:"Mathematics for BME",emoji:"📐",level:"Beginner",duration:"6 hours",color:"#f472b6",grad:"linear-gradient(135deg,#831843,#9d174d)",
    lessons:[{id:"ma-1",title:"Calculus: Differentiation Basics",mins:55},{id:"ma-2",title:"Integration & Area Under Curves",mins:55},{id:"ma-3",title:"Differential Equations in Biology",mins:65},{id:"ma-4",title:"Linear Algebra: Vectors & Matrices",mins:55},{id:"ma-5",title:"Matrix Applications in Medical Imaging",mins:55},{id:"ma-6",title:"Numerical Methods & Computational Thinking",mins:45}],
    quiz:[{q:"The derivative of position with respect to time gives:",o:["Acceleration","Velocity","Force","Energy"],a:1},{q:"Differential equations in pharmacokinetics model:",o:["Protein folding","Drug concentration over time","Cell membrane potential","Bone stress"],a:1},{q:"In medical imaging (CT/MRI), matrices are used for:",o:["Protein synthesis","Image reconstruction and transformation","DNA sequencing","Fluid simulation"],a:1},{q:"Integration is most useful for:",o:["Finding instantaneous rate of change","Calculating total accumulated quantities","Solving algebraic equations","Measuring voltage"],a:1},{q:"An eigenvalue problem in BME is commonly used in:",o:["Organic chemistry reactions","Biosignal processing (PCA)","Anatomical dissection","Drug synthesis"],a:1}]},
  { id:"bme-skills",title:"BME Skills & Career",emoji:"🎯",level:"Beginner",duration:"5 hours",color:"#fb923c",grad:"linear-gradient(135deg,#7c2d12,#c2410c)",
    lessons:[{id:"sk-1",title:"Programming for BME: Python Basics",mins:60},{id:"sk-2",title:"Data Analysis & Scientific Python",mins:55},{id:"sk-3",title:"CAD & Design Software (Fusion 360)",mins:55},{id:"sk-4",title:"Technical Writing & Scientific Communication",mins:45},{id:"sk-5",title:"Networking, Research & Lab Opportunities",mins:50}],
    quiz:[{q:"Which programming language is most recommended for first-year BME students?",o:["C++","Java","Python","Assembly"],a:2},{q:"CAD stands for:",o:["Computer-Aided Diagnosis","Computer-Aided Design","Cellular Anatomy Database","Computed Axial Data"],a:1},{q:"IMRD in scientific writing stands for:",o:["Introduction, Methods, Results, Discussion","Index, Model, Ratio, Data","Imaging, Measurement, Resolution, Depth","Integration, Matrices, Regression, Derivatives"],a:0},{q:"BMES stands for:",o:["Biomedical Engineering & Medical Systems","Biomedical Engineering Society","Biomechanical Evaluation & Measurement Society","Basic Medical Education Standards"],a:1},{q:"The best first step to get involved in research is:",o:["Wait until junior year","Apply for PhD programs immediately","Email a professor with genuine interest in their work","Only attend career fairs"],a:2}]},
  ...
  { id:"bioinformatics",title:"Bioinformatics",emoji:"💻",level:"Intermediate",duration:"7 hours",color:"#f472b6",grad:"linear-gradient(135deg,#831843,#9d174d)",
    ...
    quiz:[{q:"The human genome contains approximately:",o:["3 million base pairs","3 billion base pairs","300 thousand genes","3 trillion cells"],a:1},{q:"BLAST is a tool for:",o:["3D protein visualization","Sequence alignment & database search","Flow cytometry","RNA sequencing only"],a:1},{q:"AlphaFold predicts:",o:["Genes expression levels","Protein 3D structure from sequence","Drug toxicity","DNA methylation"],a:1},{q:"CRISPR-Cas9 cuts DNA at:",o:["Random locations","Guide RNA-specified target sequences","Promoter regions only","Introns only"],a:1},{q:"CNNs in BME are used for:",o:["Sequence alignment","Medical image analysis","PCR amplification","Gel electrophoresis"],a:1}]},
  ...
  { id:"drug-delivery",title:"Drug Delivery Systems",emoji:"💊",level:"Advanced",duration:"8 hours",color:"#10b981",grad:"linear-gradient(135deg,#064e3b,#047857)",
    lessons:[{id:"dd-1",title:"Pharmacokinetics & Drug Release",mins:60},{id:"dd-2",title:"Nanoparticles & Liposomes",mins:85},{id:"dd-3",title:"Controlled Release Polymers",mins:80},{id:"dd-4",title:"Targeted Drug Delivery",mins:75},{id:"dd-5",title:"Clinical Trials & Regulatory Pathway",mins:65}],
    quiz:[{q:"Bioavailability refers to:",o:["Drug toxicity level","Fraction of drug reaching systemic circulation","Speed of drug metabolism","Drug solubility in water"],a:1},{q:"Liposomes are used in drug delivery because:",o:["They are insoluble in blood","They can encapsulate both hydrophilic and hydrophobic drugs","They increase drug toxicity","They are made of metal"],a:1},{q:"EPR effect (Enhanced Permeability & Retention) is exploited in:",o:["Gene therapy","Cancer nanomedicine","Antibiotics","Vaccine delivery"],a:1},{q:"Controlled release polymers degrade by:",o:["Combustion","Hydrolysis or enzymatic cleavage","Evaporation","Radiation"],a:1},{q:"A prodrug is:",o:["An inactive precursor that converts to active drug in the body","A drug that targets the brain only","A drug with no side effects","A synthetic hormone"],a:0}]},
];
...
function Nav({page,setPage,xp}){
  ...
  return(<nav className="nav-bar"><div className="nav-inner">
    ...
    <div style={{display:"flex",alignItems:"center",gap:8,flexShrink:0}}>
      ...
      {!installed&&<button onClick={install} style={{display:"flex",alignItems:"center",gap:5,padding:"4px 10px",borderRadius:20,background:"rgba(34,211,238,0.1)",border:"1px solid rgba(34,211,238,0.3)",color:"#22d3ee",fontSize:"0.75rem",fontWeight:600,cursor:"pointer",fontFamily:"'DM Sans',sans-serif",flexShrink:0}}>📲 Install</button>}
      {installed&&<span style={{fontSize:"0.72rem",color:"rgba(34,211,238,0.5)",flexShrink:0}}>✓ Installed</span>}
      {showInstallTip&&!installed&&<div style={{position:"fixed",top:90,right:16,zIndex:200,background:"#0f1929",border:"1px solid rgba(34,211,238,0.35)",borderRadius:14,padding:"16px 18px",maxWidth:270,boxShadow:"0 8px 32px rgba(0,0,0,0.6)"}}><button onClick={()=>setShowInstallTip(false)} style={{position:"absolute",top:8,right:12,background:"none",border:"none",color:"rgba(255,255,255,0.4)",cursor:"pointer",fontSize:"1.1rem",lineHeight:1}}>×</button>{isIOS?(<><p style={{fontWeight:700,fontSize:"0.85rem",marginBottom:8,color:"white",paddingRight:16}}>Install on iPhone / iPad</p><p style={{color:"rgba(255,255,255,0.6)",fontSize:"0.78rem",lineHeight:1.7}}>1. Tap the <strong style={{color:"#22d3ee"}}>Share</strong> button ↑ in Safari<br/>2. Scroll down and tap <strong style={{color:"#22d3ee"}}>Add to Home Screen</strong><br/>3. Tap <strong style={{color:"#22d3ee"}}>Add</strong></p></>):(<><p style={{fontWeight:700,fontSize:"0.85rem",marginBottom:8,color:"white",paddingRight:16}}>Install BioMedAI</p><p style={{color:"rgba(255,255,255,0.6)",fontSize:"0.78rem",lineHeight:1.7}}>Open this page in <strong style={{color:"#22d3ee"}}>Chrome</strong> or <strong style={{color:"#22d3ee"}}>Edge</strong> and tap the install icon ⊕ in the address bar — or reload the page to trigger the install prompt.</p></>)}</div>}
